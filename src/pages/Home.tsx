          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl p-6 border-t-4 border-accent1">
              <div className="flex items-start justify-between border-b border-slate-100 pb-4 mb-4">
                <div>
                  <h3 className="font-serif text-2xl font-bold text-primary mb-1">Guaranteed Quality</h3>
                  <p className="text-slate-500 font-sans text-sm">Auckland Wide Service</p>
                </div>
                <div className="h-12 w-12 rounded-full bg-accent1/10 flex items-center justify-center text-accent1 shrink-0 shadow-sm border border-accent1/20">
              ...
              <div className="space-y-4">
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-primary text-sm">Fully Licensed & Insured</h4>
                    <p className="text-xs text-slate-600 mt-1">Working safely and compliantly to New Zealand electrical standards.</p>
                  </div>
                </div>
                <div className="flex gap-3 items-start">
                  <CheckCircle2 className="h-5 w-5 text-accent1 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-bold text-primary text-sm">No Hidden Costs</h4>
                    <p className="text-xs text-slate-600 mt-1">Transparent quoting and fair pricing on all residential & commercial jobs.</p>
                  </div>
                </div>
              </div>
